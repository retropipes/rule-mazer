...
public abstract class GenericWallTrap extends MazeObject {
	...
	Main.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this.masterTrigger);
	if (this.number == GenericWallTrap.NUMBER_MASTER) {
	    Main.getApplication().getMazeManager().getMaze().masterTrapTrigger();
	} else {
	    Main.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this);
	    Main.getApplication().getMazeManager().getMaze().findAllMatchingObjectsAndDecay(this.trigger);
	}
