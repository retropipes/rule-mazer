...
public class MazeObjectList {
    ...
    private final MazeObject[] allObjects = { new Empty(), new Grass(), new Dirt(), new Sand(), new Snow(),
	    ...
	    new SkyCarpet(), new WhiteCarpet(), new YellowCarpet(), new Player(), new SunStone(), new Finish(),
	    new FakeFinish(), new FinishTo(), new MovingFinish(), new Wall(), new InvisibleWall(), new FakeWall(),
	    ...
	    new YellowWallOff(), new YellowWallOn(), new CyanWallOff(), new CyanWallOn(), new OneWayEastWall(),
	    new OneWayNorthWall(), new OneWaySouthWall(), new OneWayWestWall(), new ExplodingWall(),
	    new BreakableWallHorizontal(), new BreakableWallVertical(), new FadingWall(), new DamageableWall(),
	    new CrackedWall(), new DamagedWall(), new CrumblingWall(), new MasterTrappedWall(), new TrappedWall0(),
	    ...
	    new TrappedWall16(), new TrappedWall17(), new TrappedWall18(), new TrappedWall19(), new Stump(),
	    new Crevasse(), new BrickWall(), new Hammer(), new Axe(), new Tree(), new CutTree(), new Tablet(),
	    new TabletSlot(), new EnergySphere(), new APlug(), new APort(), new BPlug(), new BPort(), new CPlug(),
	    new CPort(), new DPlug(), new DPort(), new EPlug(), new EPort(), new FPlug(), new FPort(), new GPlug(),
	    new GPort(), new HPlug(), new HPort(), new IPlug(), new IPort(), new JPlug(), new JPort(), new KPlug(),
	    new KPort(), new LPlug(), new LPort(), new MPlug(), new MPort(), new NPlug(), new NPort(), new OPlug(),
	    new OPort(), new PPlug(), new PPort(), new QPlug(), new QPort(), new RPlug(), new RPort(), new SPlug(),
	    new SPort(), new TPlug(), new TPort(), new UPlug(), new UPort(), new VPlug(), new VPort(), new WPlug(),
	    new WPort(), new XPlug(), new XPort(), new YPlug(), new YPort(), new ZPlug(), new ZPort(),
	    ...
	    new InvisibleOneShotConditionalTeleport(), new StairsUp(), new StairsDown(), new Pit(), new InvisiblePit(),
	    ...
	    new WarpTrap(), new ArrowTrap(), new MasterWallTrap(), new WallTrap0(), new WallTrap1(), new WallTrap2(),
	    new WallTrap3(), new WallTrap4(), new WallTrap5(), new WallTrap6(), new WallTrap7(), new WallTrap8(),
	    new WallTrap9(), new WallTrap10(), new WallTrap11(), new WallTrap12(), new WallTrap13(), new WallTrap14(),
	    new WallTrap15(), new WallTrap16(), new WallTrap17(), new WallTrap18(), new WallTrap19(),
	    new TreasureChest(), new DimnessGem(), new DarknessGem(), new LightnessGem(), new BrightnessGem(),
	    new DarkGem(), new LightGem(), new HorizontalBarrier(), new VerticalBarrier(), new BarrierGenerator(),
	    new EnragedBarrierGenerator(), new IcedBarrierGenerator(), new PoisonedBarrierGenerator(),
	    new ShockedBarrierGenerator(), new WarpBomb(), new IceBomb(), new FireBomb(), new PoisonBomb(),
	    new ShockBomb(), new QuakeBomb(), new ShuffleBomb(), new IceBow(), new FireBow(), new PoisonBow(),
	    new ShockBow(), new GhostBow(), new Sign(), new MinorHealPotion(), new MinorHurtPotion(),
	    new MinorUnknownPotion(), new MajorHealPotion(), new MajorHurtPotion(), new MajorUnknownPotion(),
	    new SuperHealPotion(), new SuperHurtPotion(), new SuperUnknownPotion(), new CrystalWall(),
	    new BlackCrystal(), new BlueCrystal(), new CyanCrystal(), new DarkBlueCrystal(), new DarkCyanCrystal(),
	    new DarkGrayCrystal(), new DarkGreenCrystal(), new DarkMagentaCrystal(), new DarkRedCrystal(),
	    new DarkYellowCrystal(), new GrayCrystal(), new GreenCrystal(), new LightBlueCrystal(),
	    new LightCyanCrystal(), new LightGrayCrystal(), new LightGreenCrystal(), new LightMagentaCrystal(),
	    new LightRedCrystal(), new LightYellowCrystal(), new MagentaCrystal(), new OrangeCrystal(),
	    new PlantCrystal(), new PurpleCrystal(), new RedCrystal(), new RoseCrystal(), new SeaweedCrystal(),
	    new SkyCrystal(), new WhiteCrystal(), new YellowCrystal(), new HalfHourglass(), new Hourglass(),
	    new DoubleHourglass(), new Amethyst(), new Ruby(), new Sapphire(), new Diamond(), new NormalAmulet(),
	    new FireAmulet(), new IceAmulet(), new GhostAmulet(), new PoisonousAmulet(), new CounterpoisonAmulet(),
	    new TrueSightAmulet(), new BlueHouse(), new CyanHouse(), new GreenHouse(), new MagentaHouse(),
	    new OrangeHouse(), new PurpleHouse(), new RedHouse(), new RoseHouse(), new SeaweedHouse(), new SkyHouse(),
	...
	int count = 0;
	for (x = 0; x < this.allObjects.length; x++) {
	    if (this.allObjects[x].getLayer() == layer && !this.allObjects[x].hasPrerequisite()
    ...
    public final static MazeObject[] getAllRequiredSubset(final MazeObject[] objs, final int layer) {
	if (objs == null) {
	    return null;
	}
    ...
    public final static MazeObject[] getAllWithoutPrerequisiteAndNotRequiredSubset(final MazeObject[] objs,
	    final int layer) {
	if (objs == null) {
	    return null;
	}
	...
	for (x = 0; x < objs.length; x++) {
	    if (objs[x].hasRuleSet()) {
		if (objs[x].getLayer() == layer && !objs[x].getRuleSet().isRequired() && !objs[x].hasPrerequisite()) {
		    tempAllWithoutPrereq[count] = objs[x];
		    count++;
		}
	    } else {
		if (objs[x].getLayer() == layer && !objs[x].isRequired() && !objs[x].hasPrerequisite()) {
		    tempAllWithoutPrereq[count] = objs[x];
		    count++;
		}
	    }
    ...
    public final MazeObject[] getAllWithNthPrerequisite(final int layer, final int N) {
    ...
    public final static MazeObject[] getAllWithNthPrerequisiteSubset(final MazeObject[] objs, final int layer,
	    final int N) {
	if (objs == null) {
	    return null;
	}
