...
public class GraphicsManager {
	...
	try {
	    ...
	    final URL url = GraphicsManager.LOAD_CLASS
		    .getResource(GraphicsManager.LOAD_PATH + "objects/" + normalName + ".png");
	...
	try {
	    ...
	    final String normalName = GraphicsManager.normalizeName(name);
	    final URL url = GraphicsManager.LOAD_CLASS
		    .getResource(GraphicsManager.LOAD_PATH + "stats/" + normalName + ".png");
	    final BufferedImage image = ImageIO.read(url);
	    final BufferedImageIcon icon = new BufferedImageIcon(image);
	    // Transform the icon
	...
	try {
	    final URL url = GraphicsManager.LOAD_CLASS.getResource(GraphicsManager.LOAD_PATH + "logo/" + name + ".png");
	    final BufferedImage image = ImageIO.read(url);
	    final BufferedImageIcon icon = new BufferedImageIcon(image);
	    return icon;
	} catch (final IOException ie) {
