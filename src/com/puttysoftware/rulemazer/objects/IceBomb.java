...
public class IceBomb extends GenericUsableObject {
	...
	Main.getApplication().getMazeManager().getMaze().radialScanFreezeObjects(x, y, z, IceBomb.EFFECT_RADIUS);
	// Freeze ground, too
	Main.getApplication().getMazeManager().getMaze().radialScanFreezeGround(x, y, z, IceBomb.EFFECT_RADIUS);
    }
