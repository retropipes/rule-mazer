...
public class RotationWand extends GenericWand {
	...
	final String rres = CommonDialogs.showInputDialog("Rotation Radius:", "RuleMazer", rChoices, rChoices[r - 1]);
	try {
	...
	final String dres = CommonDialogs.showInputDialog("Rotation Direction:", "RuleMazer", dChoices, dChoices[di]);
