...
public class ShockBomb extends GenericUsableObject {
	...
	Main.getApplication().getMazeManager().getMaze().radialScanShockObjects(x, y, z, ShockBomb.EFFECT_RADIUS);
	// Shock the ground, too
	Main.getApplication().getMazeManager().getMaze().radialScanShockGround(x, y, z, ShockBomb.EFFECT_RADIUS);
    }
