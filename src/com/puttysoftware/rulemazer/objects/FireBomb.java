...
public class FireBomb extends GenericUsableObject {
	...
	Main.getApplication().getMazeManager().getMaze().radialScanEnrageObjects(x, y, z, FireBomb.EFFECT_RADIUS);
	// Burn the ground, too
	Main.getApplication().getMazeManager().getMaze().radialScanBurnGround(x, y, z, FireBomb.EFFECT_RADIUS);
    }
