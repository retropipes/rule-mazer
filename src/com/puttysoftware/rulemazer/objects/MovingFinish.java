...
public class MovingFinish extends Finish {
	...
	this.active = true;
	this.activateTimer(Main.getApplication().getMazeManager().getMaze().getFinishMoveSpeed());
    }
	...
	this.active = false;
	final MazeObject obj = Main.getApplication().getMazeManager().getMazeObject(this.getDestinationRow(),
	...
	Main.getApplication().showMessage(this.getName() + ": Next Moving Finish (" + (this.getDestinationColumn() + 1)
