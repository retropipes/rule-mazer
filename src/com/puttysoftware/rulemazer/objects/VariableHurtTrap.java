...
public class VariableHurtTrap extends GenericTrap {
	...
	this.maxDamage = Main.getApplication().getMazeManager().getMaze().getMaximumHP() / 10;
	...
	Main.getApplication().getMazeManager().getMaze().doDamage(this.damageDealt.generate());
