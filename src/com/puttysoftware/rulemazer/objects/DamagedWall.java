...
public class DamagedWall extends GenericWall {
	...
	// Destroy the wall
	final int pz = Main.getApplication().getGameManager().getPlayerManager().getPlayerLocationZ();
	Main.getApplication().getGameManager().morph(new CrumblingWall(), dirX, dirY, pz);
