...
class LayeredTower implements Cloneable {
    ...
    public static LayeredTower readXMLLayeredTowerV1(final XMLDataReader reader,
        ...
        for (x = 0; x < lt.getColumns(); x++) {
            for (y = 0; y < lt.getRows(); y++) {
                for (z = 0; z < lt.getFloors(); z++) {
                    for (e = 0; e < MazeConstants.LAYER_COUNT; e++) {
                        lt.setCell(
                                Main.getApplication().getObjects()
    ...
    public static LayeredTower readXMLLayeredTowerV2(final XMLDataReader reader,
            final int ver) throws IOException {
        int y, x, z, e, mazeSizeX, mazeSizeY, mazeSizeZ;
        mazeSizeX = reader.readInt();
        mazeSizeY = reader.readInt();
    ...
    public static LayeredTower readXMLLayeredTowerV3(final XMLDataReader reader,
            final int ver) throws IOException {
        int y, x, z, e, mazeSizeX, mazeSizeY, mazeSizeZ;
        mazeSizeX = reader.readInt();
        mazeSizeY = reader.readInt();
    ...
    public static LayeredTower readXMLLayeredTowerV4(final XMLDataReader reader,
            final int ver) throws IOException {
        int y, x, z, e, mazeSizeX, mazeSizeY, mazeSizeZ;
        mazeSizeX = reader.readInt();
        mazeSizeY = reader.readInt();
