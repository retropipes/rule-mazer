...
public class MazeManager {
	...
	if (saved) {
		...
		if (ff.getDescription().equals(xmf.getDescription())) {
		    PreferencesManager.setLastFilterUsedOpen(PreferencesManager.FILTER_XML_MAZE);
		} else {
		    PreferencesManager.setLastFilterUsedOpen(PreferencesManager.FILTER_XML_GAME);
		}
