...
public class XMLDataWriter {
    ...
    // Constructors
    public XMLDataWriter(final String filename, final String newDocTag) throws IOException {
	...
	this.bw.write("<" + XMLDataConstants.INT_TAG + ">" + Integer.toString(i) + "</" + XMLDataConstants.INT_TAG + ">"
		+ XMLDataWriter.END_OF_LINE);
    }

    public void writeLong(final long l) throws IOException {
	this.bw.write("<" + XMLDataConstants.LONG_TAG + ">" + Long.toString(l) + "</" + XMLDataConstants.LONG_TAG + ">"
		+ XMLDataWriter.END_OF_LINE);
    }

    public void writeByte(final byte b) throws IOException {
	this.bw.write("<" + XMLDataConstants.BYTE_TAG + ">" + Byte.toString(b) + "</" + XMLDataConstants.BYTE_TAG + ">"
		+ XMLDataWriter.END_OF_LINE);
    }

    public void writeBoolean(final boolean b) throws IOException {
	this.bw.write("<" + XMLDataConstants.BOOLEAN_TAG + ">" + Boolean.toString(b) + "</"
		+ XMLDataConstants.BOOLEAN_TAG + ">" + XMLDataWriter.END_OF_LINE);
    }

    public void writeString(final String s) throws IOException {
	this.bw.write("<" + XMLDataConstants.STRING_TAG + ">" + s + "</" + XMLDataConstants.STRING_TAG + ">"
		+ XMLDataWriter.END_OF_LINE);
    }
